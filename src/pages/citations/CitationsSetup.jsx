...
const BUSINESS_CATEGORIES = [
  ...
  { value: 'Chiropractic Office', label: 'Chiropractic Office' },
  { value: 'Real Estate Agency', label: 'Real Estate Agency' },
  { value: 'Law Firm', label: 'Law Firm' },
  { value: 'Accounting / Tax Service', label: 'Accounting / Tax Service' },
  { value: 'Insurance Agency', label: 'Insurance Agency' },
  { value: 'Home Inspection Service', label: 'Home Inspection Service' },
